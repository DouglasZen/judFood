...
<html ng-app="app">
	...
	<body  background="/restaurante/views/static/images/restaurante.jpg" style="background-attachment: fixed;background-position: center;background-repeat: no-repeat;background-size: cover;">
		<div id="wrapper">
			<div id="page-wrapper">
				<div class="body">  
